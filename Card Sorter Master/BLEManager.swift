...
class BLEManager: NSObject, ObservableObject, CBCentralManagerDelegate, CBPeripheralDelegate{
    ...
    func sendMessage(data: String){
        ...
        if let HM10Peripheral = HM10Peripheral {
            if let HM10MessageCharacteristic = HM10MessageCharacteristic {
                HM10Peripheral.writeValue(valueString!, for: HM10MessageCharacteristic, type: .withoutResponse)
            }
        }
    }
